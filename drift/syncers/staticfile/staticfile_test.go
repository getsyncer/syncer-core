...
syncs:
  - logic: staticfile
    config:
      filename: testfile_1
      content: Static sync content THIS FILE IS ` + `AUTOGENERATED BY SYNCER  DO NOT EDIT
`
	...
	t.Run("no-change", drifttest.WithRun(config, files.SimpleState(map[string]string{
		"testfile_1": "Static sync content THIS FILE IS " + "AUTOGENERATED BY SYNCER  DO NOT EDIT",
